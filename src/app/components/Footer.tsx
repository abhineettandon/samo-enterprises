        ...
        <footer className="border-t border-border">
            <div className="max-w-7xl mx-auto px-6 py-12 grid grid-cols-1 md:grid-cols-3 gap-10">
                <div className="flex flex-col items-center justify-center text-center">
                    <Link to="/" className="flex flex-row items-center justify-between leading-none">
                        <img src="/img/logo.png" alt="samo-enterprises" className="object-cover w-28 h-28 z-10" />
                        <img src="/img/tagline.jpg" alt="tagline" className="h-6 -m-6" />
                    </Link>
